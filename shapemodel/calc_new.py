...
def calculate_PCA_analysis(num_modes):
    ...
    gen_train = getGeneralization_train(num_modes, point_embedder)
...
path1 = "/home/sci/asmak/Documents/Methods/ssm/Ground_Truth/femur/20_percent_gt/training.training"
template = "n11_L_femur_1x_hip_gt"

path2 = "/home/sci/asmak/Documents/Methods/weaklyssm/BCP/20_percent_femur/training.training"


tmp_dir = os.path.join(path2, "tmp")
...
train_dt_path = os.path.join(path1, "groomed", "distance_transforms")
train_mesh_path = os.path.join(path1, "groomed", "mesh")
train_particles_path = os.path.join(path1, "shape_models_1024", "la_particles")

test_dt_path = os.path.join(path2, "groomed", "distance_transforms")
test_mesh_path = os.path.join(path2, "groomed", "mesh")
test_particles_path = os.path.join(path2, "shape_models_1024", "la_particles")
...
out = np.array(out)
np.savez(os.path.join(path2, "groomed_test", "stats_new.npz"), comp=out[:,0], spec=out[:,1], gen=out[:,2], gen_train=out[:,3])
tqdm.write("---- Done ----")
