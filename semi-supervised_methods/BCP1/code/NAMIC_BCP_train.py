from asyncio import * # from asyncore import write
import importlib
import os
...
parser.add_argument('--root_path', type=str, default='/home/sci/asmak/Documents/Methods/BCP/data_split/namic', help='Name of Dataset')
...
parser.add_argument('--max_samples', type=int,  default=50, help='maximum samples to train')
...
val_image_list = glob.glob(os.path.join(train_data_path, "test", "*.h5"))
...
def pre_train(args, snapshot_path):
    ...
    db_train = FemurDSet(base_dir=train_data_path,
                       split='train',
    ...
    # k-fold: namic
    # labeled_idxs = list(range(40, 50))   # Hardcoded for max_samples=50 and labelnum=10
    # unlabeled_idxs = list(range(0, 40))  # Rest of the samples

    # 10% namic:
    labeled_idxs = list(range(labelnum))
    unlabeled_idxs = list(range(labelnum, 50)) # 10% of 50 data = 5
    ...
    for epoch_num in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            if iter_num % 200 == 0:
                ...
                dice_sample = test_3d_patch.var_all_case(model, val_image_list, num_classes=num_classes, patch_size=patch_size, stride_xy=18, stride_z=4)
                if dice_sample > best_dice:
                    ...
                    print("ASMAAAAAAAAA Saving model to:", save_best_path)
...
if __name__ == "__main__":
    ## make logger file
    pre_snapshot_path = "./model/BCP/namic_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./model/BCP/namic_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
    ...
    shutil.copy('../code/NAMIC_BCP_train.py', self_snapshot_path)
    # -- Pre-Training
