...
parser.add_argument('--model', type=str,  default='namic', help='model_name')
...
test_save_path = "./model_" + args.dataset + "/testing/" + args.model + "/"
...
if args.dataset == 'la':
    ...
    with open(args.root_path + 'test_namic.txt', 'r') as f:
        image_list = f.readlines()
