...
snapshot_path = "./model/BCP/Femur_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
test_save_path = "./model/BCP/Femur_{}_{}_labeled/test_predictions/".format(FLAGS.exp, FLAGS.labelnum)
num_classes = 2
...
def test_calculate_metric():
    ...
    avg_metric = test_all_case(model, image_list, num_classes=num_classes,
                           patch_size=(128, 96, 112), stride_xy=18, stride_z=4,
