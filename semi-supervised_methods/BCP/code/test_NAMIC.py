...
parser.add_argument('--root_path', type=str, default='/home/sci/asmak/Documents/Methods/BCP/data_split/namic', help='Name of Experiment')
...
snapshot_path = "./model/BCP/namic_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
test_save_path = "./model/BCP/namic_{}_{}_labeled/test_predictions/".format(FLAGS.exp, FLAGS.labelnum)
num_classes = 2
...
image_list = glob.glob(os.path.join(FLAGS.root_path, "test", "*.h5"))
...
def test_calculate_metric():
    ...
    avg_metric = test_all_case(model, image_list, num_classes=num_classes,
                           patch_size=(112, 80, 80), stride_xy=18, stride_z=4,
