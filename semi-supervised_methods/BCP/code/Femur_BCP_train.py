...
parser.add_argument('--max_samples', type=int,  default=40, help='maximum samples to train')
...
def pre_train(args, snapshot_path):
    ...
    # unlabeled_idxs = list(range(labelnum, 40))

    # k-fold: femur
    # labeled_idxs = list(range(32, 40))  # samples=40 and labelnum=8
    # unlabeled_idxs = list(range(0, 32))  # Rest of the samples

    # 10% femur:
    labeled_idxs = list(range(4))
    unlabeled_idxs = list(range(4, 40)) # 10% of 40 data = 4
...
if __name__ == "__main__":
    ## make logger file
    pre_snapshot_path = "./model/BCP/Femur_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./model/BCP/Femur_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
    ...
    shutil.copy('../code/Femur_BCP_train.py', self_snapshot_path)
    # -- Pre-Training
