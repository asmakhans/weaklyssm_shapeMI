...
snapshot_path = "./model/further/namic_{}_{}_memory{}_feat{}_labeled_numfiltered_{}_consistency_{}_rampup_{}_consis_o_{}_iter_{}_seed_{}/{}".format(
    FLAGS.exp,
    FLAGS.labelnum, 
    FLAGS.memory_num,
    FLAGS.embedding_dim,
    ...
    FLAGS.model)
print(snapshot_path)
test_save_path = FLAGS.root_path + "model/{}_{}_{}_labeled/training_predictions/{}_predictions/".format(FLAGS.dataset_name, FLAGS.exp,
                                                                                   FLAGS.labelnum, FLAGS.model)

num_classes = 2
if FLAGS.dataset_name == "namic":
    patch_size = (112, 112, 80)
    FLAGS.root_path = FLAGS.root_path + 'data/namic'
